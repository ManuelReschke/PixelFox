...
func newsEditContent(news models.News) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var2 templ.SafeURL = templ.SafeURL("/admin/news/update/" + strconv.FormatUint(news.ID, 10))
