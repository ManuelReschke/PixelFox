...
func LoginIndex(fromProtected bool, csrfToken string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<section class=\"card w-fit bg-base-200 shadow-xl mx-auto mb-8\"><div class=\"card-body pb-2\"><h1 class=\"card-title border-b border-b-slate-600 pb-[4px]\">Einloggen</h1><!-- Social Login zuerst --><div class=\"flex flex-col gap-2 w-96 mt-2\"><a href=\"/auth/google\" class=\"btn btn-outline w-full\" hx-boost=\"false\" target=\"_top\" rel=\"external noopener\">Mit Google einloggen</a> <a href=\"/auth/facebook\" class=\"btn btn-outline w-full\" hx-boost=\"false\" target=\"_top\" rel=\"external noopener\" disabled>*Soon* Mit Facebook einloggen</a> <a href=\"/auth/discord\" class=\"btn btn-outline w-full\" hx-boost=\"false\" target=\"_top\" rel=\"external noopener\" disabled>*Soon*Mit Discord einloggen</a></div><p class=\"text-sm text-base-content/70 w-96 mt-3\">Hinweis: Beim ersten Login über einen Social Provider wird automatisch ein Konto erstellt.</p><div class=\"divider\">oder</div><form hx-swap=\"transition:true\" hx-headers=\"js:{'X-TimeZone': Intl.DateTimeFormat().resolvedOptions().timeZone}\" class=\"rounded-xl drop-shadow-xl flex flex-col gap-4 w-96 p-8\" action=\"\" method=\"post\"><input type=\"hidden\" name=\"_csrf\" value=\"")
		if templ_7745c5c3_Err != nil {
